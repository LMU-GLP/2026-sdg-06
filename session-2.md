...
5. GitHub asks whether Claude can access your account. Press the green
   **Authorize** button
6. Back in the repo list, search for `2026-sdg-06` and click
   **LMU-GLP/2026-sdg-06**

**Repo not in the list?** You haven't accepted the invitation to it yet. Open
**[github.com/LMU-GLP/2026-sdg-06/invitations](https://github.com/LMU-GLP/2026-sdg-06/invitations)**
...
[github.com/LMU-GLP/2026-sdg-06](https://github.com/LMU-GLP/2026-sdg-06).
...
```
Set up this repo as an LLM wiki for our challenge: "How might we help communities protect clean water and use it more wisely?"
...
https://sdgs.un.org/goals/goal6, one dataset with real figures, and one
...
[your repo](https://github.com/LMU-GLP/2026-sdg-06) and click the
**Pull requests** tab.
...
**[github.com/LMU-GLP/2026-sdg-06/tree/main/wiki](https://github.com/LMU-GLP/2026-sdg-06/tree/main/wiki)**
...
**https://lmu-glp.github.io/2026-sdg-06/**
...
[your repo](https://github.com/LMU-GLP/2026-sdg-06) → **Pull requests** tab.
